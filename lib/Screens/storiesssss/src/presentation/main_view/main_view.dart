...
import 'package:tinderapp/Screens/storiesssss/src/presentation/bar_tools/bottom_tools.dart';
...
class _MainViewState extends State<MainView> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: _popScope,
      child: Scaffold(
        backgroundColor: widget.editorBackgroundColor == Colors.transparent
            ? Colors.black
